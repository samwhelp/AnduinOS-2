...
function mount_folders() {
    ...
    sudo mkdir -p new_building_os/root/build
    sudo cp -rfT $SCRIPT_DIR/mods new_building_os/root/build/mods
    sudo cp -f $SCRIPT_DIR/args.sh   new_building_os/root/build/args.sh
    sudo cp -f $SCRIPT_DIR/shared.sh new_building_os/root/build/shared.sh
}
...
function run_chroot() {
    ...
    print_warn "============================================"
    sudo chroot new_building_os /usr/bin/env DEBIAN_FRONTEND=${DEBIAN_FRONTEND:-readline} /root/build/mods/rundown.sh -
    print_warn "============================================"
...
function umount_folders() {
    ...
    sudo rm -rf new_building_os/root/build
